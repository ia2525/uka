...
def get_policies():
    return [
        ...
        },
        {
            ...
            "description": "In March 2025, reports emerged that the UK government is considering linking its ETS with the EU's carbon market...",
            "status": "Interest Expressed; Formal Talks Pending",
            "Key Dates to Watch": "UK-EU Summit (May 2025)...",
            "Latest Developments": "The EU-UK Parliamentary Partnership Assembly (PPA) took place on 17 March 2025...",
        ...
        },
        {
            ...
            "description": "The UK government is exploring the inclusion of waste incineration facilities and the Maritime Sector in the UK ETS...",
            "status": "Proposed",
            "last_updated": "2025-04-14",
            "search_url": [
